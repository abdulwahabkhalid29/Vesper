			...
			<section class="middle">
				<div class="container">
					<div class="row align-items-start justify-content-between">
						...
						@include('site.partial.user-sidebar')

                        <div class="col-12 col-md-12 col-lg-8 col-xl-8">
							<!-- row -->
                            {!! Form::model($user, ['route' => ['profile-update' , auth()->user()->id] , 'enctype' => 'multipart/form-data']) !!}
							<div class="row align-items-center">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<div class="form-group mt-3">
											<label class="small text-dark ft-medium">Profile Pic *</label>
                                            <input type="file" name="image" class="form-control">
                                            @if ($user->image)
                                                <img src="{{ asset('upload/profile/'.$user->image) }}" class="img-thumbnail mt-2" width="100px" alt="">
                                            @endif
										</div>
									</div>

                                        <div class="form-group mt-3">
                                            <button type="submit" class="float-right btn btn-dark">Save Changes</button>
										</div>
                                        </div>
                                        {!! Form::close() !!}
                                        {!! Form::model($user, ['route' => 'password-update' , auth()->user()->id]) !!}
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 ">
                                                <div class="form-group mt-3">
                                                    ...
                                                    @if(Session::has("password"))<small class="text-danger">{{Session::get('password')}}</small>@endif <br>
                                                </div>
                                            </div>

                                            <div style="margin-top: -25px;" class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                <div class="form-group mt-3">
                                                ...
                                                <div class="form-group mt-2">
                                                    <button type="submit" class="float-right btn btn-dark">Update Password</button>
                                                </div>
                                        </div>
                                            {!! Form::close() !!}
                                    </div>
							...
							<div class="quick_view_wrap">
								...
								<div class="quick_view_thmb">
									<div class="quick_view_slide">
										<div class="single_view_slide"><img src="{{ asset('asset/img/product/1.jpg') }}" class="img-fluid" alt="" /></div>
										<div class="single_view_slide"><img src="{{ asset('asset/img/product/2.jpg') }}" class="img-fluid" alt="" /></div>
										<div class="single_view_slide"><img src="{{ asset('asset/img/product/3.jpg') }}" class="img-fluid" alt="" /></div>
										<div class="single_view_slide"><img src="{{ asset('asset/img/product/4.jpg') }}" class="img-fluid" alt="" /></div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/tshirt.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
									<div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">T-Shirts</a></h6></div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/pant.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
									<div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">Pants</a></h6></div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/fashion.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
									<div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">Women's</a></h6></div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/sneakers.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
									<div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">Shoes</a></h6></div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/television.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
									<div class="sl_cat_02"><h6 class="m-0 ft-medium fs-sm"><a href="javascript:void(0);">Television</a></h6></div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-4 mb-3">
								<div class="cats_side_wrap text-center">
									<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray"><a href="javascript:void(0);" class="d-block"><img src="{{ asset('asset/img/accessories.png') }}" class="img-fluid" width="40" alt="" /></a></div></div>
					...
					<div class="right-ch-sideBar">
						...
						<div class="cart_select_items py-2">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{ asset('asset/img/product/4.jpg') }}" width="60" class="img-fluid" alt="" /></a>
									</div>
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{ asset('asset/img/product/7.jpg') }}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
							...
							<div class="d-flex align-items-center justify-content-between px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{ asset('asset/img/product/8.jpg') }}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
